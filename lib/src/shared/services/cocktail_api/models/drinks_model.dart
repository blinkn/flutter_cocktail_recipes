class CocktailApiDrinks {
  List<CocktailApiDrink> drinks;

  CocktailApiDrinks({this.drinks});

  CocktailApiDrinks.fromJson(Map<String, dynamic> json) {
    if (json['drinks'] != null) {
      drinks = new List<CocktailApiDrink>();
      json['drinks'].forEach((v) {
        drinks.add(new CocktailApiDrink.fromJson(v));
      });
    }
  }
...
class CocktailApiDrink {
  ...
  CocktailApiDrink.fromJson(Map<String, dynamic> json) {
